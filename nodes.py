...
class ResearchNodes:
    def __init__(self):
        ...
        print("🔧 Initializing ResearchNodes...")
        ...
        print("✅ ResearchNodes initialized")
...
if __name__ == "__main__":
    ...
    if not groq_key:
        ...
        print(f"✅ Plan created with {len(test_state['research_plan'])} steps")
        print(f"📋 Steps: {test_state['research_plan']}")
